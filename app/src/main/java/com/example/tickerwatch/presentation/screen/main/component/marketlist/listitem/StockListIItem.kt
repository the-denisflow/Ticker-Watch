...
@Composable
private fun StockListItemTechPreview() {
    StockUiListItem(stock = previewStockTech, isInWatchlist = true)
}

@Preview(showBackground = true)
@Composable
private fun StockListItemCryptoPreview() {
    StockUiListItem(stock = previewStockCrypto, isInWatchlist = false)
}